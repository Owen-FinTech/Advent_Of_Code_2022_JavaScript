...
for (let i = 0; i < singleArray.length; i += 4) {
    if (Number(singleArray[i]) <= Number(singleArray[i + 2]) && Number(singleArray[i + 1]) >= Number(singleArray[i + 3])) {
        total += 1;
    } else if (Number(singleArray[i]) >= Number(singleArray[i + 2]) && Number(singleArray[i + 1]) <= Number(singleArray[i + 3])) {
        total += 1;
    }
}
